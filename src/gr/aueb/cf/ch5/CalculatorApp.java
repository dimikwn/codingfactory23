 ...
 * Εμφανίζει ένα menu προς τον χρήστη με
 * επιλογές, λαμβάνει την τιμη της επιλογής
 * και στη συνέχεια 2 ακόμα τιμές των num1, num2.
 * Και τέλικα, εμφανίζει το αποτέλεσμα.
 */
